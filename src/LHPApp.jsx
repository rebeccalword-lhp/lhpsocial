...
const featuredEvents = [
  ...
  { id: "pk3", venue: "packys", thisWeek: true, title: "Gus Rios @ Packy's", org: "Packy's Sports Pub · 4480 N Federal Hwy, LHP", date: "Wed, May 6", time: "5:30 - 8:30 PM", price: "Free · Kitchen open late · Free parking", emoji: "🎤", note: "Solo performer", link: "https://www.packyslhp.com", color: "#0096C7", category: ["nightlife"] },
  { id: "pk4", venue: "packys", thisWeek: true, title: "How Original @ Packy's", org: "Packy's Sports Pub · 4480 N Federal Hwy, LHP", date: "Fri, May 8", time: "8:00 PM - 12:00 AM", price: "Free · Kitchen open late · Free parking", emoji: "🎸", note: null, link: "https://www.packyslhp.com", color: "#0077B6", category: ["nightlife"] },
  { id: "pk5", venue: "packys", thisWeek: true, title: "Nobody's Fault @ Packy's", org: "Packy's Sports Pub · 4480 N Federal Hwy, LHP", date: "Sat, May 9", time: "8:00 PM - 12:00 AM", price: "Free · Kitchen open late · Free parking", emoji: "🎸", note: null, link: "https://www.packyslhp.com", color: "#0077B6", category: ["nightlife"] },
  ...
  { id: "pk7", venue: "packys", thisWeek: true, title: "Nigh Horizon @ Packy's", org: "Packy's Sports Pub · 4480 N Federal Hwy, LHP", date: "Fri, May 15", time: "8:00 PM - 12:00 AM", price: "Free · Kitchen open late · Free parking", emoji: "🎸", note: null, link: "https://www.packyslhp.com", color: "#0077B6", category: ["nightlife"] },
  ...
  { id: "p4", venue: "papas", thisWeek: true, title: "Pierre @ Papa's Raw Bar", org: "Papa's Raw Bar", date: "Fri, May 8", time: "7-10 PM", price: "Free", emoji: "🎵", note: null, link: null, color: "#52B788", category: ["nightlife"] },
  { id: "p5", venue: "papas", thisWeek: true, title: "Justin Enco @ Papa's Raw Bar", org: "Papa's Raw Bar", date: "Sat, May 9", time: "7-10 PM", price: "Free", emoji: "🎵", note: null, link: null, color: "#52B788", category: ["nightlife"] },
  { id: "p6", venue: "papas", thisWeek: true, title: "Marina Laurendi @ Papa's Raw Bar", org: "Papa's Raw Bar", date: "Sun, May 10", time: "1-4 PM", price: "Free", emoji: "🎵", note: "Sunday afternoon music", link: null, color: "#52B788", category: ["nightlife"] },
  { id: "p7", venue: "papas", thisWeek: true, title: "Pierre @ Papa's Raw Bar", org: "Papa's Raw Bar", date: "Fri, May 15", time: "7-10 PM", price: "Free", emoji: "🎵", note: null, link: null, color: "#52B788", category: ["nightlife"] },
  ...
  { id: "g5", venue: "galuppis", thisWeek: true, title: "High Tide - Yacht Rock Night", org: "Galuppi's · Pompano Beach", date: "Wed, May 6", time: "Evening", price: "$49.95/person", emoji: "🛥️", note: "Classics from the 70s & 80s · 3-course dinner +$29.95", link: "https://www.galuppis.com/event/high-tide-presents-yacht-rock-3/", color: "#0077B6", category: ["nightlife", "seniors"] },
  { id: "g6", venue: "galuppis", thisWeek: true, title: "The 807 Band - FREE", org: "Galuppi's · Pompano Beach", date: "Thu, May 7", time: "Evening", price: "FREE", emoji: "🎸", note: "Rock classic dance music", link: "https://www.galuppis.com/event/the-807-band-12/", color: "#52B788", category: ["nightlife"] },
  { id: "g7", venue: "galuppis", thisWeek: true, title: "Hot Brass - Chicago & EWF Tribute", org: "Galuppi's · Pompano Beach", date: "Fri, May 8", time: "Evening", price: "RSVP", emoji: "🎺", note: "Tribute to Chicago and Earth, Wind & Fire", link: "https://www.galuppis.com/event/hot-brass-4/", color: "#00B4A6", category: ["nightlife", "seniors"] },
  { id: "g8", venue: "galuppis", thisWeek: true, title: "True Rumours - Fleetwood Mac Tribute", org: "Galuppi's · Pompano Beach", date: "Sat, May 9", time: "Evening", price: "RSVP", emoji: "🎤", note: "Fleetwood Mac tribute + Stevie Nicks Look-Alike Contest!", link: "https://www.galuppis.com/event/true-rumours-7/", color: "#48CAE4", category: ["nightlife"] },
  { id: "g9", venue: "galuppis", thisWeek: true, title: "Mother's Day Brunch & Dinner Buffet", org: "Galuppi's · Pompano Beach", date: "Sun, May 10", time: "Brunch & Dinner", price: "$50 deposit", emoji: "🌸", note: "Special Mother's Day celebration", link: "https://www.galuppis.com/event/mothers-day-brunch-dinner-buffet/", color: "#48CAE4", category: ["nightlife", "families", "seniors"] },
  { id: "g10", venue: "galuppis", thisWeek: true, title: "Miz' Behavin' - FREE", org: "Galuppi's · Pompano Beach", date: "Sun, May 10", time: "Evening", price: "FREE", emoji: "🎵", note: "Rock, Country, Pop & Blues", link: "https://www.galuppis.com/event/miz-behavin/", color: "#52B788", category: ["nightlife"] },
  { id: "g11", venue: "galuppis", thisWeek: true, title: "Mixtape FM - 80s Night", org: "Galuppi's · Pompano Beach", date: "Fri, May 15", time: "Evening", price: "RSVP", emoji: "📼", note: "80s Rock & Pop Cover Bands", link: "https://www.galuppis.com/event/mixtape-fm/", color: "#0096C7", category: ["nightlife"] },
  ...
  { id: "elks1", venue: "all", thisWeek: true, title: "Live Music by Sherlock Homies", org: "Pompano Beach Elks Lodge · 4000 NE 10th Way, Pompano Beach", date: "Thu, May 8", time: "6:00 PM", price: "Free", emoji: "🎸", note: "Acoustic music by Sherlock Homies & friends - Jay Marienthal, Lyla Marienthal, Craig Pugatch", link: null, color: "#52B788", category: ["nightlife"] },
];

const byteEvents = [
  { id: "b1", title: "Backgammon Night", org: "Byte & Coffee · 2424 N Federal Hwy, Lighthouse Point", category: ["social"], date: "Every Friday", time: "6:00 - 9:00 PM", location: "Byte & Coffee, Lighthouse Point", price: "Free · Food & drinks available", color: "#48CAE4", tags: ["backgammon", "games", "weekly", "social"], note: "All skill levels welcome. Casual evening of backgammon, drinks & good vibes.", ages: null, link: "https://bytencoffee.com/events/" },
...
const events = [
  ...
  { id: "bingo1", thisWeek: true, title: "Norcrest PTA Bingo Night", org: "Norcrest Elementary PTA · 4000 NE 10th Way, Pompano Beach", category: ["social", "families", "community"], date: "Sat, May 9", time: "5:00 - 9:00 PM", location: "4000 NE 10th Way, Pompano Beach", price: "Free", color: "#48CAE4", tags: ["bingo", "fundraiser", "kids", "community", "social"], note: "Bingo Night benefiting Norcrest PTA", ages: "All ages", link: "https://www.facebook.com/NorcrestPTA" },
  ...
  { id: 11, title: "Pickleball Clinics", org: "John Trudel Community Center", category: ["fitness"], date: "Wednesdays", time: "5-6 PM (Beginners) · 6-7 PM (Int/Advanced)", location: "John Trudel Community Center", price: "$20/clinic", color: "#52B788", tags: ["pickleball", "sports", "weekly"], note: null, ages: null, link: "https://lhp.recdesk.com" },
  ...
  { id: "tc11", thisWeek: true, title: "Advanced LiveBall Tennis 3.5+", org: "LHP Tennis Center · 3500 NE 27th Ave · (954) 946-7306", category: ["fitness"], date: "Every Saturday", time: "9:00 - 10:30 AM", location: "LHP Tennis Center, 3500 NE 27th Ave", price: "Call for pricing · (954) 946-7306", color: "#52B788", tags: ["tennis", "advanced", "liveball", "weekly", "saturday", "morning"], note: "Sign up on Court Reserve app or call the Pro Shop. Members 7 days advance · Non-members 5 days prior.", ages: "3.5+ level", link: null },
  ...
  { id: 14, thisWeek: true, title: "Robotics Class", org: "John Trudel Community Center", category: ["families"], date: "Thursdays - ends May 21", time: "4:00-6:00 PM", location: "John Trudel Community Center", price: "$270 res / $297 non-res", color: "#0077B6", tags: ["STEM", "robotics", "kids"], note: "Trial class available", ages: "K-4th grade", link: "https://lhp.recdesk.com" },
  ...
  { id: 18, thisWeek: true, title: "Flower Power Floral Arranging", org: "John Trudel Community Center", category: ["arts", "seniors"], date: "Wed, May 6", time: "6:00 - 8:00 PM", location: "John Trudel Community Center", price: "$50", color: "#48CAE4", tags: ["floral", "art", "workshop"], note: null, ages: null, link: "https://lhp.recdesk.com" },
  ...
  { id: 33, title: "Compost Pilot Program - Limited Spots!", org: "City of Lighthouse Point x Filthy Organics", category: ["community"], date: "Apply now - first come, first served", time: "Ongoing", location: "Citywide", price: "Free · First 50 residents", color: "#52B788", tags: ["sustainability", "composting", "free"], note: "5-gallon compost bucket + twice-weekly drop-off access", ages: null, link: "https://www.lighthousepointfl.gov/369/Composting" },
...
export default function LHPApp() {
  ...
  const thisWeekEvents = [...allEvents, ...featuredEvents].filter(e => e.thisWeek);
  ...
  return (
    <div style={styles.root}>
      ...
      <div style={styles.thisWeekWrap}>
        <button
          onClick={() => setShowThisWeek(!showThisWeek)}
          style={{ ...styles.thisWeekBtn, background: showThisWeek ? "#0077B6" : "#E8F4FD", color: showThisWeek ? "#fff" : "#0077B6" }}>
          📅 {showThisWeek ? "← Back to All" : "Happening This Week →"}
        </button>
        {showThisWeek && (
          <div style={styles.thisWeekList}>
            <div style={styles.thisWeekLabel}>May 6 - 15 · This Week in LHP</div>
              ...
              <div key={ev.id} style={{ ...styles.musicCard, borderLeft: `4px solid ${ev.color}` }}>
                <div style={styles.musicLeft}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    {ev.price && <div style={{ ...styles.musicPrice, color: ev.color }}>🎟 {ev.price}</div>}
                  </div>
                </div>
              </div>
            ))}
...
const styles = {
  ...
  thisWeekWrap: { margin: "12px 16px 0" },
  thisWeekBtn: { border: "none", borderRadius: 20, padding: "9px 20px", fontSize: 13, fontWeight: 800, cursor: "pointer", width: "100%", transition: "all 0.15s" },
  thisWeekList: { marginTop: 12 },
  thisWeekLabel: { fontSize: 11, fontWeight: 900, color: "#0077B6", letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 10 },
